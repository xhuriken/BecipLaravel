...
/* harmony import */ var _utils_loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/loader */ "./resources/js/utils/loader.js");
/* harmony import */ var _utils_loader__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_utils_loader__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _utils_universal_alerts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/universal_alerts */ "./resources/js/utils/universal_alerts.js");
/* harmony import */ var _utils_universal_alerts__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_utils_universal_alerts__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _utils_datatables__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/datatables */ "./resources/js/utils/datatables.js");
...
/***/ "./resources/js/home/project_name.js":
/*!*******************************************!*\
  !*** ./resources/js/home/project_name.js ***!
  \*******************************************/
/***/ (() => {
...
/***/ "./resources/js/project/project_actions.js":
/*!*************************************************!*\
  !*** ./resources/js/project/project_actions.js ***!
  \*************************************************/
/***/ (() => {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (downloadBtn) {
    downloadBtn.addEventListener('click', function (e) {
      ...
      var checkedBoxes = document.querySelectorAll('input[name="download_files[]"]:checked');
      ...
      checkedBoxes.forEach(function (cb) {
        var path = cb.getAttribute('data-file-path');
        var originalName = cb.getAttribute('data-filename');
        fileInfos.push({
          path: path,
      ...
      function downloadNextFile() {
        ...
        var cleanName = info.filename.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
  ...
  if (distributeBtn) {
    distributeBtn.addEventListener('click', function (e) {
      ...
      var fileCheckboxes = document.querySelectorAll('input[name="print_files[]"]:checked');
      var fileIds = [];
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('click', function (event) {
    if (event.target.closest('.save-user')) {
      ...
      var newName = $row.find('.user-name input').val().trim();
      ...
      fetch(route, {
        ...
        if (data.success) {
          ...
          $row.find('.user-role').text(window.allRoles[newRole]).attr('data-role', newRole);
...
jQuery(document).ready(function ($) {
  function getNonOrderableColumns(tableSelector) {
    var nonOrderable = [];
    $("".concat(tableSelector, " thead th")).each(function (index) {
